...
public class IgnoreOrderFlag extends AbstractFlagConstraint implements TypeConstraint {
	...
	public boolean isInheritable() {
		// XXX Not inheritable b/c the primary use case at the time of
		// implementation is to support <xs:all> groups in type definitions and
		// such types can't be inherited from. If another use case for this flag
		// arises this might need to be reconsidered.
		return false;
	}
